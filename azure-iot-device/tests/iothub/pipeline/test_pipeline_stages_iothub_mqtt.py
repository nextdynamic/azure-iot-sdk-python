...
@pytest.mark.describe("IoTHubMQTTConverterStage object")
class TestIoTHubMQTTConverterStage(object):
    pass


pipeline_stage_test.add_base_pipeline_stage_tests(
    test_cls=TestIoTHubMQTTConverterStage,
...
class TestIoTHubMQTTConverterWithUpdateSasTokenOperationDisconnected(object):
    ...
    def test_lower_stage_update_sas_token_fails(self, stage, op, arbitrary_exception):
        op.action = "exception"
        stage.run_op(op)
